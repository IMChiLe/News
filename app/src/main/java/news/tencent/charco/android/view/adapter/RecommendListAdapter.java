 ...
 */
public class RecommendListAdapter extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> implements View.OnClickListener {
     ...
     */
    public RecommendListAdapter(List<MultiItemEntity> data) {
        super(data);
        addItemType(RECOMMENDS_SUBJECT, R.layout.item_recommend_six_photo);
