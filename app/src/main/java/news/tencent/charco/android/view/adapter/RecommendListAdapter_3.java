 ...
 */
public class RecommendListAdapter_3 extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> implements View.OnClickListener {
     ...
     */
    public RecommendListAdapter_3(List<MultiItemEntity> data) {
        super(data);
        addItemType(RECOMMENDS_SUBJECT, R.layout.item_news_hot_image);
        ...
        addItemType(RECOMMENDS_VIDEO, R.layout.item_recommend_video);
