...
import news.tencent.charco.android.view.adapter.RecommendListAdapter_3;
 ...
 */
public class RecommendListFragment_3 extends BaseFragment implements RecyclerView.OnChildAttachStateChangeListener,
        OnRefreshListener,
    ...
    private RecommendListAdapter_3 mAdapter_1;



    private int key=0;

    public static RecommendListFragment_3 newInstance(Bundle args) {
        RecommendListFragment_3 f = new RecommendListFragment_3();
        f.setArguments(args);
        return f;
    }
    ...
    public void initView(View rootView) {
        ...
        mAdapter_1 = new RecommendListAdapter_3(null);
